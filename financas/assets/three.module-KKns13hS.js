...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ea(e,t,n){let r=new Float32Array(fa),i=new J(0,1,0);return new oi({name:`SphericalGaussianBlur`,defines:{n:fa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Da(){return new oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oa(){return new oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}var Aa=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Kr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Dr(s,c),u=new Pi(-1,1,1,-1,0,1),d=null,f=null,p=!1,m,h=null,_=[],v=!1;this.setSize=function(e,t){a.setSize(e,t),o.setSize(e,t);for(let n=0;n<_.length;n++){let r=_[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){_=e,v=_.length>0&&_[0].isRenderPass===!0;let t=a.width,n=a.height;for(let e=0;e<_.length;e++){let r=_[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(p||e.toneMapping===0&&_.length===0)return!1;if(h=t,t!==null){let e=t.width,n=t.height;(a.width!==e||a.height!==n)&&this.setSize(e,n)}return v===!1&&e.setRenderTarget(a),m=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return v},this.end=function(e,t){e.toneMapping=m,p=!0;let n=a,r=o;for(let i=0;i<_.length;i++){let a=_[i];if(a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1)){let e=n;n=r,r=e}}if(d!==e.outputColorSpace||f!==e.toneMapping){d=e.outputColorSpace,f=e.toneMapping,c.defines={},X.getTransfer(d)===`srgb`&&(c.defines.SRGB_TRANSFER=``);let t=Ra[f];t&&(c.defines[t]=``),c.needsUpdate=!0}c.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(h),e.render(l,u),h=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),s.dispose(),c.dispose()}}var Ba=new xt,Va=new qr(1,1),Ha=new Tt,Ua=new Et,Wa=new Kr,Ga=[],Ka=[],qa=new Float32Array(16),Ja=new Float32Array(9),Ya=new Float32Array(4);function Xa(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=Ga[i];if(a===void 0&&(a=new Float32Array(i),Ga[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function Za(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function Qa(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function $a(e,t){let n=Ka[t];n===void 0&&(n=new Int32Array(t),Ka[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function eo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function to(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Za(n,t))return;e.uniform2fv(this.addr,t),Qa(n,t)}}function no(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(Za(n,t))return;e.uniform3fv(this.addr,t),Qa(n,t)}}function ro(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Za(n,t))return;e.uniform4fv(this.addr,t),Qa(n,t)}}function io(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Za(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),Qa(n,t)}else{if(Za(n,r))return;Ya.set(r),e.uniformMatrix2fv(this.addr,!1,Ya),Qa(n,r)}}function ao(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Za(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),Qa(n,t)}else{if(Za(n,r))return;Ja.set(r),e.uniformMatrix3fv(this.addr,!1,Ja),Qa(n,r)}}function oo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(Za(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),Qa(n,t)}else{if(Za(n,r))return;qa.set(r),e.uniformMatrix4fv(this.addr,!1,qa),Qa(n,r)}}function so(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function co(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Za(n,t))return;e.uniform2iv(this.addr,t),Qa(n,t)}}function lo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Za(n,t))return;e.uniform3iv(this.addr,t),Qa(n,t)}}function uo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Za(n,t))return;e.uniform4iv(this.addr,t),Qa(n,t)}}function fo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function po(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(Za(n,t))return;e.uniform2uiv(this.addr,t),Qa(n,t)}}function mo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(Za(n,t))return;e.uniform3uiv(this.addr,t),Qa(n,t)}}function ho(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(Za(n,t))return;e.uniform4uiv(this.addr,t),Qa(n,t)}}function go(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(Va.compareFunction=n.isReversedDepthBuffer()?518:515,a=Va):a=Ba,n.setTexture2D(t||a,i)}function _o(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||Ua,i)}function vo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||Wa,i)}function yo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||Ha,i)}function bo(e){switch(e){case 5126:return eo;case 35664:return to;case 35665:return no;case 35666:return ro;case 35674:return io;case 35675:return ao;case 35676:return oo;case 5124:case 35670:return so;case 35667:case 35671:return co;case 35668:case 35672:return lo;case 35669:case 35673:return uo;case 5125:return fo;case 36294:return po;case 36295:return mo;case 36296:return ho;case 35678:case 36198:case 36298:case 36306:case 35682:return go;case 35679:case 36299:case 36307:return _o;case 35680:case 36300:case 36308:case 36293:return vo;case 36289:case 36303:case 36311:case 36292:return yo}}function xo(e,t){e.uniform1fv(this.addr,t)}function So(e,t){let n=Xa(t,this.size,2);e.uniform2fv(this.addr,n)}function Co(e,t){let n=Xa(t,this.size,3);e.uniform3fv(this.addr,n)}function wo(e,t){let n=Xa(t,this.size,4);e.uniform4fv(this.addr,n)}function To(e,t){let n=Xa(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function Eo(e,t){let n=Xa(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function Do(e,t){let n=Xa(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function Oo(e,t){e.uniform1iv(this.addr,t)}function ko(e,t){e.uniform2iv(this.addr,t)}function Ao(e,t){e.uniform3iv(this.addr,t)}function jo(e,t){e.uniform4iv(this.addr,t)}function Mo(e,t){e.uniform1uiv(this.addr,t)}function No(e,t){e.uniform2uiv(this.addr,t)}function Po(e,t){e.uniform3uiv(this.addr,t)}function Fo(e,t){e.uniform4uiv(this.addr,t)}function Io(e,t,n){let r=this.cache,i=t.length,a=$a(n,i);Za(r,a)||(e.uniform1iv(this.addr,a),Qa(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?Va:Ba;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function Lo(e,t,n){let r=this.cache,i=t.length,a=$a(n,i);Za(r,a)||(e.uniform1iv(this.addr,a),Qa(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||Ua,a[e])}function Ro(e,t,n){let r=this.cache,i=t.length,a=$a(n,i);Za(r,a)||(e.uniform1iv(this.addr,a),Qa(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||Wa,a[e])}function zo(e,t,n){let r=this.cache,i=t.length,a=$a(n,i);Za(r,a)||(e.uniform1iv(this.addr,a),Qa(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||Ha,a[e])}function Bo(e){switch(e){case 5126:return xo;case 35664:return So;case 35665:return Co;case 35666:return wo;case 35674:return To;case 35675:return Eo;case 35676:return Do;case 5124:case 35670:return Oo;case 35667:case 35671:return ko;case 35668:case 35672:return Ao;case 35669:case 35673:return jo;case 5125:return Mo;case 36294:return No;case 36295:return Po;case 36296:return Fo;case 35678:case 36198:case 36298:case 36306:case 35682:return Io;case 35679:case 36299:case 36307:return Lo;case 35680:case 36300:case 36308:case 36293:return Ro;case 36289:case 36303:case 36311:case 36292:return zo}}var Vo=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=bo(t.type)}},Ho=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Bo(t.type)}},Uo=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},Wo=/(\w+)(\])?(\[|\.)?/g;function Go(e,t){e.seq.push(t),e.map[t.id]=t}function Ko(e,t,n){let r=e.name,i=r.length;for(Wo.lastIndex=0;;){let a=Wo.exec(r),o=Wo.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){Go(n,l===void 0?new Vo(s,e,t):new Ho(s,e,t));break}else{let e=n.map[s];e===void 0&&(e=new Uo(s),Go(n,e)),n=e}}}var qo=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);Ko(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function Jo(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var Yo=37297,Xo=0;function Zo(e,t){let n=e.split(`
`),r=[],i=Math.max(t-6,0),a=Math.min(t+6,n.length);for(let e=i;e<a;e++){let i=e+1;r.push(`${i===t?`>`:` `} ${i}: ${n[e]}`)}return r.join(`
`)}var Qo=new Y;function $o(e){X._getMatrix(Qo,X.workingColorSpace,e);let t=`mat3( ${Qo.elements.map(e=>e.toFixed(4))} )`;switch(X.getTransfer(e)){case Pe:return[t,`LinearTransferOETF`];case Fe:return[t,`sRGBTransferOETF`];default:return W(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function es(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`

`+i+`

`+Zo(e.getShaderSource(t),r)}else return i}function ts(e,t){let n=$o(t);return[`vec4 ${e}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,`}`].join(`
`)}var ns={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function rs(e,t){let n=ns[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var is=new J;function as(){return X.getLuminanceCoefficients(is),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${is.x.toFixed(4)}, ${is.y.toFixed(4)}, ${is.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
#define LOW_PRECISION`),t}var bs={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function xs(e){return bs[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var Ss={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function Cs(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:Ss[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var ws={302:`ENVMAP_MODE_REFRACTION`};function Ts(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:ws[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var Es={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function Ds(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:Es[e.combine]||`ENVMAP_BLENDING_NONE`}function Os(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function ks(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=xs(n),l=Cs(n),u=Ts(n),d=Ds(n),f=Os(n),p=os(n),m=ss(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
